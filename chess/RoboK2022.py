...
BASE_SPEED = 100
DISTANCE = 360 #36 * 10
POS_CHANGE_FROM_CENTER = 0 #мм, право+, лево- | если придётся робота сдвинуть чуть правее от центра зоны СТАРТ 
#не забыть сменить расшифровку цветов в фигуры
...
if __name__ == '__main__':
      ...
      #if orderFigures == ['blue', 'green', 'yellow', 'red']:
       #     solution = [Figure(4, 'l', 1, 1, 1), Figure(3, 'k', 2, 3, 1, 2), Figure(3, 'f', 4, 3, 1, 4), Figure(2, 's', 2, 2, 1, 3)]
