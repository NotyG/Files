...
float Kd = 600;
float slow = 1.2;
PMotor motorRight(10, 11, 12);
PMotor motorLeft(9, 8, 7);
PMotor balka(5, 22, 4); //халтура 22 свободный
QTRSensorsRC qtrrc((unsigned char[]) {
  25, 27, 29, 49, 51, 35, 37,39 //25 27 29 49 51 35 37 39
},
...
void setup() {
  ...
  /*balkaMove(OUT);*/
  kalibrovka();
 hand.attach(3); hand.write(100); delay(1000); hand.detach();
